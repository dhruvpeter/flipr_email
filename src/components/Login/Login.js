                            ...
                            <div className="login-snip"> <input id="tab-1" type="radio" name="tab" className="sign-in" checked/><label for="tab-1" className="tab">Login</label> <input id="tab-2" type="radio" name="tab" className="sign-up"/><label for="tab-2" className="tab">Sign Up</label>
                                <div className="login-space">
                                    <div className="login">
                                        ...
                                        <div className="group"> <button  className="button"><FontAwesomeIcon icon={faGoogle} style={{marginRight:"10%",fontSize:"1.5rem"}}  /><span className="buttonText">Sign in with Google</span></button> </div>
                                        </div>
                                    ...
                                    <div className="sign-up-form">
                                        ...
                                        <div className="sign"> 
                                        <div className="group"> <input type="submit" className="button" value="Sign Up"/> </div></div>
                                        <div className="hr"></div>
